...
<html>
 ...
 <div class="maincontented_gallary template clear">
 	<div class="gallary template clear">
 		<ul>
 			<li>
 				<a href="#"> <img src="image/gal.jpg"alt="Facebook"/></a>
 				<a href="#"><h5>Details</h5></a>	
 			</li>
 			<li>
 				<a href="#"> <img src="image/gal1.jpg"alt="Facebook"/></a> 
 				<a href="#"><h5>Details</h5></a>	
 			</li>
 			<li>
 				<a href="#"> <img src="image/gal2.jpg"alt="Facebook"/></a>
 				<a href="#"><h5>Details</h5></a>	
 			</li>
 			<li>
 				<a href="#"> <img src="image/gal3.jpg"alt="Facebook"/></a>
 				<a href="#"><h5>Details</h5></a>	
 	...
 	<div class="gallary template clear">
 		<ul>
 			<li>
 				<a href="#"> <img src="image/gal4.jpg"alt="Facebook"/></a>
 				<a href="#"><h5>Details</h5></a>	
 			</li>
 			<li>
 				<a href="#"> <img src="image/galfive.jpg"alt="Facebook"/></a> 
 				<a href="#"><h5>Details</h5></a>		
 			</li>
 			<li>
 				<a href="#"> <img src="image/gal6.jpg"alt="Facebook"/></a>
 				<a href="#"><h5>Details</h5></a>	
 			</li>
 			<li>
 				<a href="#"> <img src="image/gal7.jpg"alt="Facebook"/></a>
 				<a href="#"><h5>Details</h5></a>	
 	...
 	<div class="gallary template clear">
 		<ul>
 			<li>
 				<a href="#"> <img src="image/gal8.jpg"alt="Facebook"/></a>
 				<a href="#"><h5>Details</h5></a>	
 			</li>
 			<li>
 				<a href="#"> <img src="image/gal9.jpg"alt="Facebook"/></a> 
 				<a href="#"><h5>Details</h5></a>	
 			</li>
 			<li>
 				<a href="#"> <img src="image/gal1.jpg"alt="Facebook"/></a>
